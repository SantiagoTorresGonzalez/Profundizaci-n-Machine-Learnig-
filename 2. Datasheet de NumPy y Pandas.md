...
- **reshape:** Este comando sirve para reformar la estructura de un arreglo, podemos cambiar las filas y columnas de una matriz siempre y cuando las identifiquemos como un grupo encerrado por un paréntesis. En el siguiente ejemplo se convierte un arreglo de 3 filas y 4 columnas a uno inverso de 4 filas y 3 columnas.
**Ejemplo:**
  <img width="715" height="193" alt="Captura de pantalla 2025-08-23 231136" src="https://github.com/user-attachments/assets/834dc8c8-99ec-44ae-86b8-22d0e7dcbf31" />
